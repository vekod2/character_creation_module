...
def start_training(char_name: str, char_class: str) -> str:
    ...
    print(f'Введи одну из команд: attack — чтобы атаковать противника, '
          f'defence — чтобы блокировать атаку противника или special — чтобы '
          f'использовать свою суперсилу.')
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        char_class = input(f'Введи название персонажа, за которого хочешь '
                           f'играть: Воитель — warrior, '
                           f'Маг — mage, Лекарь — healer: ')
        if char_class == 'warrior':
